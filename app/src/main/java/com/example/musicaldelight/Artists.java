...
public class Artists extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View rootView = inflater.inflate(R.layout.artists_name, container, false);
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        RecyclerView recyclerView = Objects.requireNonNull(getActivity()).findViewById(R.id.recyclerView_Artists);
        ...
        recyclerView.setAdapter(new ArtistsAdapter(getContext(), media_cursor));


        ArtistsAdapter artistsAdapter=new ArtistsAdapter(getContext(),media_cursor);
        artistsAdapter.setOnItemClickListener(new ArtistsAdapter.ClickListener(){
            @Override
            public void onItemClick(int position, View v) {
                Log.d(TAG, "onItemClick position: " + position);
                displaySongsInArtists();
    ...
    private void displaySongsInArtists() {
